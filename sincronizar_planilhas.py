...
from dashboard_lib import r2_pull_all, r2_push_all, fetch_avise_me, fetch_reposicoes_prazo, fetch_calendario_crm, sync_newsletter_leads_to_bevean, sync_handling_days, build_dashboard_data, build_final_html, deploy_github_pages, log_line
...
if __name__ == "__main__":
    ...
    try:
        ...
        sync_newsletter_leads_to_bevean()
        sync_handling_days()
